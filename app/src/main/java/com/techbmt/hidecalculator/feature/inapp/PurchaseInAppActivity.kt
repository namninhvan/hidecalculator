...
//                        hideProgressDialog();
    ...
    private val inAppProductList: ImmutableList<Product>
        get() = ImmutableList.of(
            //Product 0
            Product.newBuilder()
                .setProductId(Constants.KEY_HIDDEN_CALCULATOR_1)
                .setProductType(ProductType.INAPP)
                .build(), //Product 1
            Product.newBuilder()
                .setProductId(Constants.KEY_HIDDEN_CALCULATOR_2)
                .setProductType(ProductType.INAPP)
                .build(),  //Product 2
            Product.newBuilder()
                .setProductId(Constants.KEY_HIDDEN_CALCULATOR_3)
                .setProductType(ProductType.INAPP)
                .build(),  //Product 3
            Product.newBuilder()
                .setProductId(Constants.KEY_HIDDEN_CALCULATOR_4)
                .setProductType(ProductType.INAPP)
                .build(),  //Product 4
            Product.newBuilder()
                .setProductId(Constants.KEY_HIDDEN_CALCULATOR_5)
                .setProductType(ProductType.INAPP)
                .build(),  //Product 5
            Product.newBuilder()
                .setProductId(Constants.KEY_HIDDEN_CALCULATOR_6)
                .setProductType(ProductType.INAPP)
                .build(),  //Product 6
            Product.newBuilder()
                .setProductId(Constants.KEY_HIDDEN_CALCULATOR_7)
                .setProductType(ProductType.INAPP)
                .build(),
            Product.newBuilder()
                .setProductId(Constants.KEY_HIDDEN_CALCULATOR_8)
                .setProductType(ProductType.INAPP)
                .build(),//Product 7
        )
...
//        assert productDetails.getSubscriptionOfferDetails() != null;
    ...
    private fun setupResult(proId: String, quantity: Int) {
        val intent = Intent()
        val totalCoin = prefs.getValueCoin()
        val remainCoin = totalCoin ?: (0 + getCoinFromKey(proId) * quantity);
        prefs.setValueCoin(remainCoin)
    ...
    private fun getCoinFromKey(coinId: String): Int {
        return when (coinId) {
            Constants.KEY_HIDDEN_CALCULATOR_1-> 5
            Constants.KEY_HIDDEN_CALCULATOR_2 -> 10
            Constants.KEY_HIDDEN_CALCULATOR_3 -> 20
            Constants.KEY_HIDDEN_CALCULATOR_4 -> 50
            Constants.KEY_HIDDEN_CALCULATOR_5 -> 100
            Constants.KEY_HIDDEN_CALCULATOR_6 -> 150
            Constants.KEY_HIDDEN_CALCULATOR_7 -> 200
            Constants.KEY_HIDDEN_CALCULATOR_8 -> 300
            else -> 0
        }
    }
